...
public class ChangeMaterial : MonoBehaviour {
...

    {
        if (c.gameObject.name == "Banana")
        {
            ...
            // Hier kijkt het of de boolean in de file spawnpinball true is, zo ja dan voert het de functie uit anders gaat het naar else
            if (GameObject.Find("Banana").GetComponent<SpawnPinball>().eventtrigger == true)    {
